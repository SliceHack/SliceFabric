...
public class Resource {
    ...
    public boolean download(IProgressListener ipl) {
        ...
        File file = new File(dst.getParent(),dst.getName() + ".bsdiff");
        ...
        if(MCEF.FORCE_LEGACY_VERSION){
            ...
            if(foundDiff){
                ...
                Util.download( "mcef-codec-patch/" + MCEF.VERSION + '/' + platform + "/Release/" + name + end + ".bsdiff", file, shouldExtract, ipl);
