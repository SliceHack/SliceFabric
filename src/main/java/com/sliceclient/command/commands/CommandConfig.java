...
import com.sliceclient.file.ConfigSaver;
...
public class CommandConfig extends Command {
    ...
    public boolean handle(String name, String[] args) {
        ...
        if(action.equalsIgnoreCase("list")) {
            ...
            File folder = new File(MinecraftClient.getInstance().runDirectory, "Slice\\configs\\");
        ...
        File configFile = new File(MinecraftClient.getInstance().runDirectory, "Slice\\configs\\" + config + ".json");
        ...
        if(action.equalsIgnoreCase("load")) {
            Slice.INSTANCE.getModuleManager().getModules().forEach(module -> module.setEnabled(false));
            configS.load();
